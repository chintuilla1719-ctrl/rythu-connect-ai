...
- Profile update API endpoint for users
- Added `.env.example` for environment configuration
- Added `uploads/.gitkeep` to preserve uploads directory structure
- Updated README and CONTRIBUTING documentation to match Node.js/MongoDB stack
